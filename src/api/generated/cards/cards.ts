...
**Pagination**: `limit` 1–100 (default 25), `offset` for paging.
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCardsOracleIdQueryKey(oracleId);
   ...
   return  { queryKey, queryFn, enabled: !!(oracleId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCardsOracleId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCardsOracleIdPrintingsQueryKey(oracleId);
   ...
   return  { queryKey, queryFn, enabled: !!(oracleId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCardsOracleIdPrintings>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCardsOracleIdPrintingsPrintingIdQueryKey(oracleId,printingId);
   ...
   return  { queryKey, queryFn, enabled: !!(oracleId && printingId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCardsOracleIdPrintingsPrintingId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
