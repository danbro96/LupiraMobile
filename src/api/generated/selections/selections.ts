...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSelectionsSelectionIdQueryKey(selectionId);
   ...
   return  { queryKey, queryFn, enabled: !!(selectionId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSelectionsSelectionId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
